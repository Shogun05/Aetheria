export const AETHERIA_NFT_ADDRESS = import.meta.env.VITE_CONTRACT_ADDRESS || '';
export const AETHERIA_MARKETPLACE_ADDRESS = import.meta.env.VITE_MARKETPLACE_ADDRESS || '';
